            ...
            <div class="me-3">
                <form method="GET" class="d-flex">
                    <div class="input-group">
                        <div class="col">
                            <input name="q" class="form-control" value="{{ request('q') }}" placeholder="Search types"/>
                        </div>
                            ...
                            <td class="py-3 text-end">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('admin.types.edit', $item->id) }}">
